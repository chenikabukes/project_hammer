...
Our model reveals significant differences in pricing strategies across vendors. Results in @tbl-modelresults suggest that vendor and brand effects are both statistically significant predictors of price. Additionally, analysis of monthly average bread prices, as shown in @fig-bread-price-trends, illustrates distinct pricing strategies across vendors, with notable variations in price stability, seasonal adjustments, and overall price levels.
